...
public class JsonSchemaManagerTest {
    ...
    @Test
    public void test_createSchema() throws SchemaException, IOException {
    ...
    @Test
    public void test_createTable() throws SchemaException, StorageException, IOException {
        DatabaseStorageManager databaseStorageManager = new DiskPageDatabaseStorageManager(dbConfig, new UnrestrictedFileHandlerPool(DefaultFileHandlerFactory.getInstance(), dbConfig), new InMemoryReservedSlotTracer());
        ColumnIndexManagerProvider columnIndexManagerProvider = new DefaultColumnIndexManagerProvider(dbConfig, new DefaultIndexStorageManagerFactory(dbConfig, new DefaultIndexHeaderManagerFactory()));
    ...
    @Test
    public void test_createIndex() throws SchemaException, StorageException, BTreeException, SerializationException, DeserializationException, DbException, IOException {
        DatabaseStorageManager databaseStorageManager = new DiskPageDatabaseStorageManager(dbConfig, new UnrestrictedFileHandlerPool(DefaultFileHandlerFactory.getInstance(), dbConfig), new InMemoryReservedSlotTracer());
        ColumnIndexManagerProvider columnIndexManagerProvider = new DefaultColumnIndexManagerProvider(dbConfig, new DefaultIndexStorageManagerFactory(dbConfig, new DefaultIndexHeaderManagerFactory()));
    ...
    @Test
    public void test_createIndexWithPreviousData() throws SchemaException, StorageException, IOException, ExecutionException, InterruptedException, DbException, BTreeException, SerializationException, DeserializationException {
    ...
    @Test
    public void test_deleteTable() throws SchemaException, IOException, StorageException, ExecutionException, InterruptedException, DbException {
        DatabaseStorageManager databaseStorageManager = new DiskPageDatabaseStorageManager(dbConfig, new UnrestrictedFileHandlerPool(DefaultFileHandlerFactory.getInstance(), dbConfig), new InMemoryReservedSlotTracer());
        ColumnIndexManagerProvider columnIndexManagerProvider = new DefaultColumnIndexManagerProvider(dbConfig, new DefaultIndexStorageManagerFactory(dbConfig, new DefaultIndexHeaderManagerFactory()));
    ...
    @Test
    public void test_deleteTableWithPreviousData() throws SchemaException, IOException, StorageException, ExecutionException, InterruptedException, DbException, BTreeException, SerializationException {
        DatabaseStorageManager databaseStorageManager = new DiskPageDatabaseStorageManager(dbConfig, new UnrestrictedFileHandlerPool(DefaultFileHandlerFactory.getInstance(), dbConfig), new InMemoryReservedSlotTracer());
        ColumnIndexManagerProvider columnIndexManagerProvider = new DefaultColumnIndexManagerProvider(dbConfig, new DefaultIndexStorageManagerFactory(dbConfig, new DefaultIndexHeaderManagerFactory()));
