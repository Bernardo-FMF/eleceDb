...
class SqlValueTest {
    @Test
    void test_number_equalValueTypes_equalValues() throws ParserException {
    ...
    @Test
    void test_number_equalValueTypes_differentValues() throws ParserException {
        SqlNumberValue sourceValue = new SqlNumberValue(1);
    ...
    @Test
    void test_string_equalValueTypes_equalValues() throws ParserException {
    ...
    @Test
    void test_string_equalValueTypes_differentValues() throws ParserException {
        SqlStringValue sourceValue = new SqlStringValue("test");
    ...
    @Test
    void test_boolean_equalValueTypes_equalValues() throws ParserException {
    ...
    @Test
    void test_boolean_equalValueTypes_differentValues() throws ParserException {
        SqlBoolValue sourceValue = new SqlBoolValue(false);
